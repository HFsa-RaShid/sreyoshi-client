...
export default function AccountSettingsPage() {
  ...
  return (
    <div className="w-full bg-white rounded-2xl border border-gray-100 p-5 md:p-8 space-y-8">
      {/* Title */}
      <div>
        <h1 className="font-bold text-[24px] md:text-[28px] text-[#0F1E29] tracking-tight">Account Settings</h1>
        <p className="text-xs font-medium text-gray-400 mt-0.5">Manage your profile, preferences, and privacy</p>
      </div>

      {/* 🎯 হিডেন ফাইল ইনপুট কন্ট্রোল */}
      <input 
        type="file" 
        ref={fileInputRef}
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between p-5 border border-gray-100 rounded-2xl bg-white gap-4">
        <div className="flex items-center gap-4 w-full sm:w-auto">
          ...
          <div 
            ...
            className="group relative w-16 h-16 rounded-full bg-[#4E612B] text-white flex items-center justify-center font-bold text-xl overflow-hidden border-2 border-gray-50 shrink-0 cursor-pointer"
          >
          ...
          <div>
            <div className="flex items-center gap-2">
              <h3 className="font-bold text-base md:text-lg text-[#0F1E29]">{user?.name || "User"}</h3>
      ...
      <div className="border border-gray-100 rounded-2xl p-5 space-y-4">
        <div className="flex items-center justify-between border-b border-gray-50 pb-3">
          <h3 className="font-bold text-[15px] text-[#0F1E29]">Personal Information</h3>
          <button 
      ...
      {/* Preferences Section */}
      <div className="border border-gray-100 rounded-2xl p-5 space-y-4">
        <h3 className="font-bold text-[15px] text-[#0F1E29] border-b border-gray-50 pb-3">Preferences</h3>
          ...
          return (
            <div key={pref.key} className="flex items-center justify-between py-1 text-xs border-t border-gray-50/50 pt-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="font-bold text-gray-800">{pref.title}</h4>
      ...
      <div className="border border-gray-100 rounded-2xl p-5 space-y-4">
        <h3 className="font-bold text-[15px] text-[#0F1E29] border-b border-gray-50 pb-3">Privacy & Security</h3>
        <div className="flex items-center justify-between py-1 text-xs">
          <div className="flex items-center gap-3">
        ...
        <div className="flex items-center justify-between py-1 text-xs border-t border-gray-50/50 pt-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h4 className="font-bold text-gray-800">Active Sessions</h4>
