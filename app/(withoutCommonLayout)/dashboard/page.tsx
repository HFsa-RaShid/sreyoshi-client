    ...
    <div className="w-full space-y-6 animate-in fade-in duration-300 font-sans text-[#1E1E1E]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
        ...
        <div className="lg:col-span-4 bg-white border border-gray-100 rounded-2xl p-5 flex flex-col justify-between shadow-2xs">
          <div>
            <h3 className="text-sm font-bold text-[#0F1E29]">
              Fulfillment Ratio
            </h3>
            <p className="text-[11px] text-gray-400 font-medium">
          ...
          <div className="w-full h-[140px] relative flex items-center justify-center my-2">
            ...
            <div className="absolute flex flex-col items-center justify-center">
              <span className="text-lg font-black text-[#0F1E29]">
                {stats.totalOrders}
              </span>
      ...
      <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-2xs">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-[11px] text-gray-400 font-medium">
              Instant tracking access for your last 3 orders
            </p>
          </div>
          <Link
            href="/dashboard/my-orders"
            className="text-xs font-bold text-[#4E612B] hover:underline flex items-center gap-0.5"
          >
          ...
          {stats.recentOrders.length === 0 ? (
            ...
            stats.recentOrders.map((order: any, idx: number) => {
              ...
              return (
                <div
                  key={order._id || idx}
                  className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-3.5 border border-gray-50 rounded-xl hover:bg-gray-50/50 transition-colors"
                >
                  ...
                  <div className="flex items-center justify-between sm:justify-end gap-6 border-t sm:border-t-0 pt-2 sm:pt-0 border-gray-100">
                    <div className="sm:text-right">
                      <p className="text-xs font-extrabold text-[#0F1E29]">
                        ৳{order.totalPrice}
                      </p>
                      <span
                        className={`inline-block text-[10px] font-bold capitalize mt-0.5 ${
                          status === "Delivered"
                            ? "text-emerald-600"
                            : status === "Cancelled"
                              ? "text-red-500"
