...
//     !cart ||
//     cart.length === 0 ||
//     cart.some((item) => item.quantity === 0 || item.error)
//   ) {
//     return (
//       <div className="min-h-[60vh] flex flex-col items-center justify-center bg-[#FAF9F6] px-4 pt-24">
//         <h2 className="font-serif text-2xl text-[#1E2E24] mb-2">
//           Invalid Cart Items Detected
//         </h2>
//         <p className="text-sm text-gray-500 mb-6">
//           Some items in your bag are out of stock or exceeded limits.
//         </p>
//         <Link
//           href="/cart"
//           className="bg-[#2C3E30] text-white px-6 py-2.5 rounded-full text-sm font-medium hover:bg-[#1A261D] transition-colors flex items-center gap-2"
//         >
...
//           <Link href="/cart" className="hover:text-[#1E2E24] transition-colors">
//             Cart
//           </Link>
...
//             className="lg:col-span-7 bg-white rounded-2xl p-6 md:p-8 shadow-[0_4px_20px_rgba(0,0,0,0.01)] border border-gray-100/60"
//           >
//             <div className="mb-8">
//               <h3 className="font-serif text-xl text-[#1E2E24] mb-4 font-normal">
//                 Contact Information
//               </h3>
...
//                     className="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm outline-none focus:border-[#2C3E30] transition-colors"
...
//                           key={zone._id}
//                           value={
//                             zone.zoneType === "inside" ? "dhaka" : "outside"
//                           }
//                         >
...
//                   className={`flex items-center justify-between p-4 rounded-xl border cursor-pointer transition-all ${paymentMethod === "COD" ? "border-[#2C3E30] bg-[#FAF9F6]" : "border-gray-200 hover:border-gray-300"}`}
//                 >
...
//                       readOnly
//                       className="accent-[#2C3E30] h-4 w-4"
//                     />
//                     <div>
//                       <span className="text-sm font-medium text-[#1E2E24] block">
...
//                   className={`flex items-center justify-between p-4 rounded-xl border cursor-pointer transition-all ${paymentMethod === "SSL" ? "border-[#2C3E30] bg-[#FAF9F6]" : "border-gray-200 hover:border-gray-300"}`}
//                 >
//                   <div className="flex items-center gap-3">
//                     <input
//                       type="radio"
...
//                       </span>
//                       <span className="text-xs text-gray-500">
//                         Pay securely via Cards or Mobile Banking.
//                       </span>
//                     </div>
//                   </div>
...
//             <h3 className="font-serif text-xl text-[#1E2E24] mb-6 font-normal pb-3 border-b border-gray-100">
//               Order Summary
//             </h3>
...
//                     </div>
//                     <div>
//                       <h4 className="text-xs md:text-sm font-medium text-[#1E2E24] line-clamp-1">
//                         {item.name}
//                       </h4>
...
//                 <span>Subtotal</span>
//                 <span className="font-medium text-[#1E2E24]">
//                   ৳{cartTotal.toFixed(2)}
//                 </span>
//               </div>
...
//               <X size={20} />
//             </button>
//             <h4 className="font-serif text-xl text-[#1E2E24] mb-2">
//               Confirm Your Order
//             </h4>
