...
export default function NewArrivals() {
  // createdAt ডেইট পার্স করে সবচেয়ে নতুন ৫টি প্রোডাক্ট আলাদা করা হলো
  const newArrivals = [...productsData]
    .sort((a, b) => new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime())
    .slice(0, 5);

  return (
    <section className="w-full bg-[#FAF9F6] py-12 px-6 md:px-16 lg:px-24 relative group/section border-t border-gray-100/50">
