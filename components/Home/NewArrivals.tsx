...
//                     className={`absolute top-3 right-3 w-9 h-9 rounded-full flex items-center justify-center shadow-sm transition-all duration-300 active:scale-90 z-10 ${
//                       isFavorite 
              ...
              >
                ...
                <div className="mt-1.5 flex flex-col grow justify-between px-2.5 md:px-4 pb-3 md:pb-4">
                  <div>
                    ...
                    <h3 className="font-sans text-xs md:text-base font-medium text-[#1E2E24] group-hover:text-[#FF3F6C] transition-colors line-clamp-2 mb-1 leading-tight h-8 md:h-12">
                      {product.name}
                    </h3>
