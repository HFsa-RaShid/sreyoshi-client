            ...
            <div className="container mx-auto h-full grid grid-cols-1 lg:grid-cols-12 items-center px-6 md:px-12 relative z-20">
              ...
              <div className="col-span-1 lg:col-span-7 flex flex-col justify-center">
                ...
                <div className="mt-8 flex items-center gap-8">
                  ...
                  <button className="bg-[#2D3B2E] hover:bg-[#1F2A20] text-white font-sans text-sm font-medium px-7 py-3 rounded-full shadow-sm transition-colors duration-300">
                    {slide.buttonText}
                  </button>

                  {/* Clean Text Link with Arrow */}
                  <a href="#" className="flex items-center gap-2 text-[#334234] hover:text-black font-sans text-sm font-medium transition-colors group">
                    {slide.linkText}
